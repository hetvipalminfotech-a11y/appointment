      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={[styles.inputWrapper, { marginBottom: 20 }]}>
            ...
            <TextInput style={styles.input} placeholder="Search patient by name or phone..." value={patientName} onChangeText={setPatientName} />
...
const styles = StyleSheet.create({
  ...
  createBtn: { flex: 2, backgroundColor: '#bae6fd', paddingVertical: '3.5%', borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginRight: '3%' },
